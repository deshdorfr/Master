...
SECRET_KEY = 'django-insecure-z3w)#aixywo2aex0b88ukhwgk2jdqj$b!v((#+6&4^8e7)%b*7'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:8000",
    "https://deshdeepak007.pythonanywhere.com/"
]
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'drf_yasg',  # Swagger package for API documentation
    'api',       # Our custom app for ESP32 communication
]
